...
export default function Customers(){
    ...
    return(
        <Box safeArea flex={1} variant="wrapper">
                    ...
                    <Box>
                        {
                            ...
                            <Pressable key={c} _pressed={{ opacity: 0.5 }} onPress={() => { setEditable(customer); setOpen(true) }}>
            ...
            <CustomerForm data={editable} isOpen={isOpen} onClose={() => { setOpen(false); setEditable(null) }} />
        </Box>
    )
}